...
//      bg.size = CGSize(width: size.width * 5, height: size.height)
    ...
    func createfalcon() {
        ...
        let physicsSize = CGFloat(24)
        
        // center falcon in Y-axis
        falcon.anchorPoint = CGPoint(x: 0.44, y: 0.38)  // have to adjust this otherwise the hitbox isn't centered
...
//            print("t53")
    ...
    func addGlider() {
        ...
        let physicsSize = CGSize(width: 380, height: 100)
        
        // change size of glider
        glider.size = CGSize(width: glider.size.width * 0.25, height: glider.size.height * 0.25)
        
        glider.anchorPoint = CGPoint(x: 0.5, y: 0.42)
        
        // add physics simulation to the glider node
        glider.physicsBody = SKPhysicsBody(rectangleOf: physicsSize)
...
//                print("you thought mia")
    ...
    func addTwotter() {
        ...
        let physicsSize = CGSize(width: size.width * 0.3, height: size.height * 0.08)
...
//                print("you thought mia")
    ...
    func addT53(){
        ...
        // change size of plane
        t53.size = CGSize(width: 400, height: 600)
        
        let physicsSize = CGSize(width: 300, height: 50)
